 ...
 */
class WPILIB_DLLEXPORT PIDControllerX
    : public wpi::Sendable,
      public wpi::SendableHelper<PIDControllerX> {
 public:
  /**
   ...
   */
  PIDControllerX(double Kp, double Ki, double Kd,
                units::second_t period = 20_ms);
 
  ~PIDControllerX() override = default;
 
  PIDControllerX(const PIDControllerX&) = default;
  PIDControllerX& operator=(const PIDControllerX&) = default;
  PIDControllerX(PIDControllerX&&) = default;
  PIDControllerX& operator=(PIDControllerX&&) = default;
